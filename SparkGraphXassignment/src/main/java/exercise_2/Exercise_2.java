...
public class Exercise_2 {
    ...
    private static class sendMsg extends AbstractFunction1<EdgeTriplet<Integer,Integer>, Iterator<Tuple2<Object,Integer>>> implements Serializable {
        ...
        public Iterator<Tuple2<Object, Integer>> apply(EdgeTriplet<Integer, Integer> triplet) {
            ...
            Integer peso = triplet.attr();
            Integer origenV = triplet.srcAttr();

            java.util.Iterator<Tuple2<Object, Integer>> resultado;
            if (origenV == Integer.MAX_VALUE) {
                resultado = Collections.emptyIterator();
            } else {
                int total = origenV + peso;
                Tuple2<Object, Integer> tuple = new Tuple2<Object, Integer>(triplet.dstId(), total);
                resultado = Collections.singletonList(tuple).iterator();
            }

            return JavaConverters.asScalaIteratorConverter(resultado).asScala();
        }
    }
